...
const SelectedDiscoveryIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none text-text-primary" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className='w-fit sm:w-[216px] shrink-0 pt-6 px-4 cursor-pointer'>
      <div>
        <Link
          href='/explore/apps'
          className={cn(isDiscoverySelected ? 'text-text-primary bg-components-main-nav-nav-button-bg-active font-semibold' : 'text-components-main-nav-nav-button-text font-medium hover:bg-components-main-nav-nav-button-bg-hover', 'flex items-center pc:justify-start pc:w-full mobile:justify-center mobile:w-fit h-9 px-3 mobile:px-2 gap-2 rounded-lg')}
      ...
      {installedApps.length > 0 && (
        <div className='mt-10'>
          <p className='pl-2 mobile:px-0 text-xs text-text-secondary break-all font-medium uppercase'>{t('explore.sidebar.workspace')}</p>
