const translation = {
  ...
  welcome: '👋 Welcome to CAN20, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting CAN20 Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on CAN20',
  invalid: 'The link has expired',
  explore: 'Explore CAN20',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on CAN20 and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The CAN20 Enterprise license for your workspace has expired. Please contact your administrator to continue using CAN20.',
